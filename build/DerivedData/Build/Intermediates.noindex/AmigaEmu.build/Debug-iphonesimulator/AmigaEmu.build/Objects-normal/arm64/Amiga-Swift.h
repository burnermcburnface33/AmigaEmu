...
#ifndef AMIGA_SWIFT_H
#define AMIGA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Amiga",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#if defined(__OBJC__)
#import "/Users/boris/Downloads/GS copy/Amiga/AmigaEmu/AmigaEmu/Bridge/AmigaEmu-Bridging-Header.h"
#else
#include "/Users/boris/Downloads/GS copy/Amiga/AmigaEmu/AmigaEmu/Bridge/AmigaEmu-Bridging-Header.h"
#endif
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC5Amiga23AmigaKeyboardController")
@interface AmigaKeyboardController : UIViewController <UIKeyInput>
...
@class UIEvent;
@class UIWindow;
SWIFT_CLASS("_TtC5Amiga10DPadUIView")
...
SWIFT_CLASS("_TtC5Amiga18EmulatorController")
@interface EmulatorController : NSObject <EmulatorBridgeDelegate>
...
- (void)emulatorDiskInsertFailed:(NSString * _Nonnull)reason;
@end

@class UIGestureRecognizer;
SWIFT_CLASS("_TtC5Amiga20EmulatorScreenUIView")
@interface EmulatorScreenUIView : UIView <UIGestureRecognizerDelegate>
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)g shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)other SWIFT_WARN_UNUSED_RESULT;
@end

@class MTKView;
/// Displays the vAmiga framebuffer. Each <code>draw(in:)</code> locks the core’s stable
...
SWIFT_CLASS("_TtC5Amiga13MetalRenderer")
